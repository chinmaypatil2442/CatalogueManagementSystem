...
$CourseId = $_SESSION['upcoming_courses-add'];
...
if (isset($_POST["submit"])) {
    $CourseId = $_SESSION['upcoming_courses-add'];
    // unset($_SESSION['upcoming_courses-add']);
    ...
    <section class="section_card">
        <a href="upcoming_courses.php">
            < Go back</a> <div align="center">
                <h2>Add a class for <?php echo $course["Name"] ?> Course for Upcoming Semester: </h2>
                </div>


                <form method="POST" name="upcoming_courses_add_form" id="upcoming_courses_add_form">
