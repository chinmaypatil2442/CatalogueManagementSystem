...
<body id="forum_page" class="forum_page">
    ...
    <header class="header">
        ...
        <div class="header_bottom_section">
            ...
            <a class="button active" href="Blog.php">Forum</a>
    ...
    <object type="text/html" data="http://cjp1732.uta.cloud/forum" style="width: 100%; height: 100vh;">
    </object>
